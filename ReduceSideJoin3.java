...
public class ReduceSideJoin3 {
	...
	public static class Map1 extends Mapper<LongWritable, Text, Text, Text> {
		public void map(LongWritable key, Text value, Context context)
			...
			context.write(new Text(mydata[2]), new Text("review\t" + mydata[20]));   //output the businessid and rating from review.csv
	...
	public static class Map2 extends Mapper<LongWritable, Text, Text, Text> {
		public void map(LongWritable key, Text value, Context context)
			...
			String[] mydata = value.toString().split("::");
			context.write(new Text(mydata[2]), new Text("business\t" + mydata[3] + "\t" + mydata[10]));   //output the businessid and fulladdress and category from business.csv
	...
	public static class Map4 extends Mapper<LongWritable, Text, Text, Text> {
		public void map(LongWritable key, Text value, Context context)
			...
			String[] mydata =  value.toString().split("::");
		    context.write(new Text(mydata[2]), new Text("business\t" + mydata[3] + "\t" + mydata[10]));
	...
	// Driver program
			public static void main(String[] args) throws Exception {
				...
				if (otherArgs.length != 3) {
					System.err.println("Usage: ReduceSideJoin3 <review> <business> <out>");
					System.exit(2);
				}
				
				Job job = new Job(conf, "ReduceSideJoin31");
				
				job.setJarByClass(ReduceSideJoin3.class);
				...
				Job job2 = new Job(conf, "ReduceSideJoin32");
				job2.setJarByClass(ReduceSideJoin3.class);
